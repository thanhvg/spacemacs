;;; config.el --- Spacemacs Defaults Layer configuration File  -*- lexical-binding: t; -*-
;;
...
(defvar spacemacs-echo-buffer-list-mapping
  '((0 . ("a" . spacemacs/switch-to-buff-1))
    (1 . ("s" . spacemacs/switch-to-buff-2))
    (2 . ("d" . spacemacs/switch-to-buff-3))
    (3 . ("f" . spacemacs/switch-to-buff-4))
    (4 . ("g" . spacemacs/switch-to-buff-5))
    (5 . ("h" . spacemacs/switch-to-buff-6))
    (6 . ("j" . spacemacs/switch-to-buff-7))
    (7 . ("k" . spacemacs/switch-to-buff-8))
    (8 . ("l" . spacemacs/switch-to-buff-9))
    (9 . (";" . spacemacs/switch-to-buff-0)))
