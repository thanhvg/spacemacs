;;; packages.el --- Spacemacs Evil Layer packages File  -*- lexical-binding: t; -*-
;;
...
(defun spacemacs-evil/init-evil-args ()
  (use-package evil-args
    ...
    (progn
      ...
      (define-key evil-normal-state-map "gbl" 'evil-forward-arg)
      (define-key evil-normal-state-map "gbh" 'evil-backward-arg)
      (define-key evil-motion-state-map "gbl" 'evil-forward-arg)
      (define-key evil-motion-state-map "gbh" 'evil-backward-arg)
      (define-key evil-normal-state-map "gbk" 'evil-jump-out-args)
